        ...
        <div class="box box-default" style="height: calc(100% - 10px);">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <asp:Button runat="server" ID="btnSubmit" Text="提交" CssClass="btn" OnClick="btnSubmit_Click" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="order-form-group">
                                            ...
                                            <span class="label_required">*</span>
                                            <input class="form-control input-sm" type="text" value="" data-itemtype="number" data-required="true" data-dataname="senderprice">
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="order-form-group">
                                            <label for="frompostcode">距離(公里)</label>
